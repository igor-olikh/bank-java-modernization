...
![Общий вид IBM Bob IDE: Explorer слева, Editor в центре, Chat справа, Terminal внизу](../images/bob-general.png)
...
![Индикатор активного режима (PLAN/ASK или CODE) в нижнем углу окна чата IBM Bob](../images/bob-modes.png)
...
![Explorer IBM Bob IDE с открытым проектом bank-java-modernization](../images/bob-explorer.png)
...
![Сравнение файлов в IBM Bob: контекстное меню Select for Compare / Compare with Selected или открытый diff-вид](../images/bob-compare.png)
...
![Кнопка «+» для нового чата (new task) в верхней части окна чата IBM Bob](../images/bob-new-task.png)
